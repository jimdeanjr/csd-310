...
DROP TABLE IF EXISTS movies.film;
...
INSERT INTO movies.studio(studio_name)
...
INSERT INTO movies.genre(genre_name)
    VALUES('Horror');
...
-- insert movie records 
	INSERT INTO movies.film(film_name, film_releaseDate, film_runtime, film_director, studio_id, genre_id)
    VALUES('Gladiator', '2000', '155', 'Ridley Scott', (SELECT studio_id FROM movies.studio WHERE studio_name = 'Universal Pictures'),(SELECT genre_id FROM movies.genre WHERE genre_name = 'Drama') );
INSERT INTO movies.film(film_name, film_releaseDate, film_runtime, film_director, studio_id, genre_id)
    VALUES('Alien', '1979', '117', 'Ridley Scott', (SELECT studio_id FROM movies.studio WHERE studio_name = '20th Century Fox'),(SELECT genre_id FROM movies.genre WHERE genre_name = 'SciFi') );

INSERT INTO movies.film(film_name, film_releaseDate, film_runtime, film_director, studio_id, genre_id)
    VALUES('Get Out', '2017', '104', 'Jordan Peele', (SELECT studio_id FROM movies.studio WHERE studio_name = 'Blumhouse Productions'),(SELECT genre_id FROM movies.genre WHERE genre_name = 'Horror') );
